...
def _clean_text(text: str, default: str = "") -> str:
    ...
    if any(ch in text for ch in ("Ù", "Ø", "â", "Ã")):
        ...
        return default
    return text.strip()
# نگارش‌های پشتیبانی‌شده: v0.1.0 تا v0.6.4
# Supported versions: v0.1.0, v0.2.0, v0.2.1, v0.2.2, v0.2.3, v0.2.4, v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9, v0.3.0, v0.3.1, v0.3.2, v0.3.3, v0.3.4, v0.3.5, v0.3.6, v0.3.7, v0.3.8, v0.3.9, v0.4.0, v0.4.1, v0.4.2, v0.4.3, v0.4.4, v0.4.5, v0.4.6, v0.4.7, v0.4.8, v0.4.9, v0.5.0, v0.5.1, v0.5.2, v0.5.3, v0.5.4, v0.5.5, v0.5.6, v0.5.7, v0.5.8, v0.5.9, v0.6.0, v0.6.1, v0.6.2, v0.6.3, v0.6.4
...
class Config:
    ...
    """
    ENGINE_VERSION: VersionStr = VersionStr((os.environ.get("ENGINE_VERSION") or "v0.7.4").strip())
    ...
    BALE_OWNER_ID: str = (os.environ.get("BALE_OWNER_ID") or os.environ.get("BALE_TARGET_CHAT_ID") or "").strip()
    ...
    MAX_SAFE_BALE_AUDIO_SIZE_MB: float = float((os.environ.get("MAX_SAFE_BALE_AUDIO_SIZE_MB") or "20.0").strip() or "20.0")
    MAX_SAFE_BALE_AUDIO_SIZE_BYTES: int = int(MAX_SAFE_BALE_AUDIO_SIZE_MB * 1024 * 1024)
    ...
    def reload_from_environ(self) -> None:
        ...
        self.BALE_OWNER_ID = (os.environ.get("BALE_OWNER_ID") or os.environ.get("BALE_TARGET_CHAT_ID") or "").strip()
        ...
        self.MAX_SAFE_BALE_AUDIO_SIZE_MB = float((os.environ.get("MAX_SAFE_BALE_AUDIO_SIZE_MB") or "20.0").strip() or "20.0")
        self.MAX_SAFE_BALE_AUDIO_SIZE_BYTES = int(self.MAX_SAFE_BALE_AUDIO_SIZE_MB * 1024 * 1024)
        ...
        self.ENGINE_VERSION = VersionStr((os.environ.get("ENGINE_VERSION") or "v0.7.4").strip())
