...
class Config:
    ...
    """
    ENGINE_VERSION: VersionStr = VersionStr((os.environ.get("ENGINE_VERSION") or "v0.7.2").strip())
    ...
    def reload_from_environ(self) -> None:
        ...
        self.ENGINE_VERSION = VersionStr((os.environ.get("ENGINE_VERSION") or "v0.7.2").strip())
