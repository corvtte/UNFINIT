...
class Config:
    ENGINE_VERSION: VersionStr = VersionStr((os.environ.get("ENGINE_VERSION") or "v0.2.2").strip())
    # 1. Telegram Secrets
    ...
    def reload_from_environ(self) -> None:
        ...
        self.ENGINE_VERSION = VersionStr((os.environ.get("ENGINE_VERSION") or "v0.2.2").strip())
    ...
    # 12. Engine Version
    ENGINE_VERSION: str = (os.environ.get("ENGINE_VERSION") or "v0.2.2").strip()
