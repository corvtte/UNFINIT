...
class TestUNFINITV034Release(unittest.TestCase):
    ...
    def test_01_pure_engine_version(self):
        ...
        self.assertIn(str(config.ENGINE_VERSION), ("v0.3.4", "v0.3.5", "v0.3.6", "v0.3.7"))
        self.assertIn(config.ENGINE_VERSION.clean, ("v0.3.4", "v0.3.5", "v0.3.6", "v0.3.7"))
        self.assertNotIn("(", str(config.ENGINE_VERSION))
        self.assertNotIn(")", str(config.ENGINE_VERSION))
        health = get_system_health()
        self.assertTrue(any(v in str(health.get("engine_version", "")) for v in ("v0.3.4", "v0.3.5", "v0.3.6", "v0.3.7")))
