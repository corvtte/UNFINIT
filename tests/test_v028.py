...
class TestV028Features(unittest.TestCase):
    ...
    def test_01_version_bump_v028(self):
        self.assertTrue(any(v in str(config.ENGINE_VERSION) for v in ('v0.2.8', 'v0.2.9', 'v0.3.0', 'v0.3.1', 'v0.3.2', 'v0.3.3', 'v0.3.4', 'v0.3.5', 'v0.3.6', 'v0.3.7')))
        health = get_system_health()
        self.assertTrue(any(v in str(health["engine_version"]) for v in ('v0.2.8', 'v0.2.9', 'v0.3.0', 'v0.3.1', 'v0.3.2', 'v0.3.3', 'v0.3.4', 'v0.3.5', 'v0.3.6', 'v0.3.7')))
