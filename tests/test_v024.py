...
class TestV024Features(unittest.TestCase):
    def test_version_v024(self):
        ...
        self.assertTrue(any(v in str(health['engine_version']) for v in ('v0.2.4', 'v0.2.5', 'v0.2.6', 'v0.2.7', 'v0.2.8', 'v0.2.9', 'v0.3.0', 'v0.3.1', 'v0.3.2', 'v0.3.3', 'v0.3.4')))
        self.assertIn(config.ENGINE_VERSION, ('v0.2.4', 'v0.2.5', 'v0.2.6', 'v0.2.7', 'v0.2.8', 'v0.2.9', 'v0.3.0', 'v0.3.1', 'v0.3.2', 'v0.3.3', 'v0.3.4'))
