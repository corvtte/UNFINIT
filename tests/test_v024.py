...
class TestV024Features(unittest.TestCase):
    def test_version_v024(self):
        ...
        self.assertTrue('v0.2.4' in str(health['engine_version']) or 'v0.2.5' in str(health['engine_version']) or 'v0.2.6' in str(health['engine_version']) or 'v0.2.7' in str(health['engine_version']))
        self.assertIn(config.ENGINE_VERSION, ('v0.2.4', 'v0.2.5', 'v0.2.6', 'v0.2.7'))
