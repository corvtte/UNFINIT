...
class TestV031Release(unittest.TestCase):
    ...
    def test_01_version_bump(self):
        self.assertIn(config.ENGINE_VERSION, ("v0.3.1", "v0.3.2", "v0.3.3", "v0.3.4", "v0.3.5"))
        health = get_system_health()
        self.assertTrue(any(v in str(health.get("engine_version", "")) for v in ("v0.3.1", "v0.3.2", "v0.3.3", "v0.3.4", "v0.3.5")))
