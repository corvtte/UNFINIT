...
class TestV025Features(unittest.TestCase):
    def test_01_version_v025(self):
        ...
        self.assertTrue('v0.2.5' in str(health['engine_version']) or 'v0.2.6' in str(health['engine_version']) or 'v0.2.7' in str(health['engine_version']))
        self.assertIn(config.ENGINE_VERSION, ('v0.2.5', 'v0.2.6', 'v0.2.7'))
