...
class TestV030EngineRelease(unittest.TestCase):
    ...
    def test_01_version_bump_v030(self):
        self.assertIn(config.ENGINE_VERSION, ("v0.3.0", "v0.3.1", "v0.3.2", "v0.3.3", "v0.3.4", "v0.3.5", "v0.3.6"))
        health = get_system_health()
        self.assertTrue(any(v in str(health["engine_version"]) for v in ("v0.3.0", "v0.3.1", "v0.3.2", "v0.3.3", "v0.3.4", "v0.3.5", "v0.3.6")))
