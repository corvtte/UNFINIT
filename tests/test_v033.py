...
class TestV033Release(unittest.TestCase):
    ...
    def test_pure_engine_version(self):
        self.assertIn(str(config.ENGINE_VERSION), ("v0.3.3", "v0.3.4", "v0.3.5", "v0.3.6", "v0.3.7", "v0.3.8"))
        health = get_system_health()
        self.assertTrue(any(v in str(health.get("engine_version", "")) for v in ("v0.3.3", "v0.3.4", "v0.3.5", "v0.3.6", "v0.3.7", "v0.3.8")))
